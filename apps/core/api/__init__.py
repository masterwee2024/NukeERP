...
from apps.core.api.advanced_audit_api import router as advanced_audit_router
...
from apps.core.api.transaction_migration_api import (
    router as transaction_migration_router,
)
...
router.add_router("/admin/", advanced_audit_router, tags=["admin"])
...
router.add_router(
    ...
    transaction_migration_router,
    tags=["transaction-migration"],
)
