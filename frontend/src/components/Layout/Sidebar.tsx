        ...
        <div className="border-b border-secondary-700 px-4 py-3">
          <div className="relative">
            ...
            >
              ...
              <span className="flex-1 truncate">{currentCompany?.name || "Select Company"}</span>
              {(companies?.length ?? 0) > 1 && (
                <svg className={`h-3 w-3 shrink-0 transition-transform ${companyOpen ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
